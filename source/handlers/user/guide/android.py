...
@rate_limit(limit=1)
async def show_help_guide_android(call: types.CallbackQuery):
    guide_images = await GuideImagesLoader().get_android_guide_images()
    ...
    await call.message.answer(
        text=localizer.get_user_localized_text(
            ...
            text_localization=localizer.message.help_guide_android,
        ),
