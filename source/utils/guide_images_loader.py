...
class GuideImagesLoader:
    def __init__(self):
        ...
        self._ios_images_paths = self._get_all_files_into_folder(
            f"{self._guide_images_path}/ios"
        )
        self._android_images_paths = self._get_all_files_into_folder(
            f"{self._guide_images_path}/android"
        )
        self._pc_images_paths = self._get_all_files_into_folder(
            f"{self._guide_images_path}/pc"
        )
